...
public abstract class BSBMParameterPool extends AbstractParameterPool {
    ...
    protected Long[] vendorOfOffer;
    protected Long[] ratingsiteOfReview;
    ...
    private void readDateAndLabelWords(File resourceDir) {
        ...
        try {
            ...
            reviewCount = currentDateAndLabelWordsInput.readLong();
            offerCount = currentDateAndLabelWordsInput.readLong();
            ...
            currentDateAndLabelWordsInput.close();
        } catch (IOException e) {
    ...
    private void readReviewSiteData(File resourceDir) {
        ...
        try {
            ...
            ratingsiteOfReview = (Long[]) reviewRatingsiteInput.readObject();
            reviewRatingsiteInput.close();
        } catch (IOException e) {
    ...
    private void readOfferAndVendorData(File resourceDir, File pp) {
        ...
        try {
            ...
            vendorOfOffer = (Long[]) offerVendorInput.readObject();
            
            offerVendorInput.close();
        } catch (IOException e) {
     ...
     * Returns the ProducerNr of given Product Nr.
     */
    protected Integer getVendorOfOffer(Long offerNr) {
     ...
     */
    protected Integer getRatingsiteOfReviewer(Long reviewNr) {
